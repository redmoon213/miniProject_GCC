...
| 적 파괴 효과 1 | 적 파괴 효과 2 | 적 파괴 효과 3 |
| :---: | :---: | :---: |
| ![EnemyDestroy](./EnemyDestroy.gif) | ![EnemyDestroy2](./EnemyDestroy2.gif) | ![EnemyDestroy3](./EnemyDestroy3.gif) |

### 2. 다양한 보스 패턴
스테이지 마지막에 등장하는 보스는 여러 단계의 공격 패턴을 가집니다.

| 투사체 패턴 | 십자 공격 패턴 | 기본 패턴 |
| :---: | :---: | :---: |
| ![BossPatternProjectile](./BossPatternProjectile.gif) | ![BossPatternCross](./BossPatternCross.gif) | ![BossPatternOriginal](./BossPatternOriginal.gif) |
...
## 🔗 관련 링크
- **GitHub Repository**: [https://github.com/redmoon213/miniProject_GCC](https://github.com/redmoon213/miniProject_GCC)
- **YouTube Demo**: [https://youtu.be/_1KbW_1ESfU](https://youtu.be/_1KbW_1ESfU)
